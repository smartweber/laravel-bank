		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu " data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="@if(strtolower($title) == 'dashboard') active open @endif">
					<a href="{{URL::route('contractor/home')}}">
					<i class="icon-home"></i>
				...
				<li class="@if(strtolower($title) == 'client contacts') active open @endif">
					<a href="javascript:;">
					<i class="fa fa-user"></i>
					<span class="title">ClientContacts</span>
					<span class="arrow "></span>
					</a>
					<ul class="sub-menu">
						<li class="@if(strtolower($sub_title) == 'all clientcontacts') active @endif">
							<a href="{{URL::route('contractor/clientcontacts')}}">
							<i class="fa fa-caret-right"></i>
							All ClientContacts</a>
						</li>
						<li class="@if(strtolower($sub_title) == 'add clientcontact' 
						|| strtolower($sub_title) == 'edit clientContact') active @endif">
							<a href="{{URL::route('contractor/clientcontact_new')}}">
							<i class="fa fa-caret-right"></i>
							Add & Edit ClientContact</a>
						</li>						
					</ul>
				</li>	
