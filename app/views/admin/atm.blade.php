          ...
          <div class="portlet box green-haze">
            ...
            <div class="portlet-body">
              ...
              <tr>
                ...
                <td>
                    {{BaseController::getRegion($atminfo->clients_id)}}
                </td>
				<td class="table-action">
				  <a href="{{ URL::route("admin/atm_edit", $atminfo->id) }}"><i class="fa fa-pencil"></i></a>
				  &nbsp;&nbsp;
				  <a href="#" onclick="doDelete('{{$atminfo->id}}')" class="delete-row{{$atminfo->id}}"><i class="fa fa-trash-o"></i></a>
				</td>              
              </tr>
              @endforeach  
              </tbody>
