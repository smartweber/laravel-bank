        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            ...
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
			  @if ($branchByID == null)
              {{Form::open(array('url' => 'admin/branch_add', 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'branchAdd', 'autocomplete' => 'off'))}}
			  @else
              {{Form::open(array('url' => 'admin/branch_update', 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'branchAdd', 'autocomplete' => 'off'))}}
			  @endif
				<input type="hidden" name="id" id="id" value="@if($branchByID != null){{$branchByID->id}}@endif">
                <div class="form-body">
                    ...
                    <div class="col-md-4">
                      <select class="form-control" name="bank">
						...
						@foreach($banks as $bankinfo)
							@if ($branchByID != null && $branchByID->bank_id == $bankinfo->id)
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-3">Bank Address <span class="required">
                    * </span>
                    </label>
                    <div class="col-md-4">
                      <input type="text" name="bankAddress" data-required="1" class="form-control" value="@if($branchByID != null){{$branchByID->bankAddress}}@endif"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-md-3">Bank Phone <span class="required">
                    * </span></label>
                    <div class="col-md-4">
                      <input type="text" name="bankPhone" data-required="1" class="form-control" value="@if($branchByID != null){{$branchByID->bankPhone}}@endif"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-md-3">Bank Contact Name <span class="required">
                    * </span></label>
                    <div class="col-md-4">
                      <input name="bankContactName" type="text" class="form-control" value="@if($branchByID != null){{$branchByID->bankContactName}}@endif"/>                      
                    </div>
                  </div>
