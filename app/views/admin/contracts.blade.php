...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
	...
	@endif
      <!-- BEGIN PAGE CONTENT-->
      {{Form::open(array('url' => 'admin/atm_delete', 'method' => 'post', 'class' => 'form', 'id' => 'atmForm', 'autocomplete' => 'off'))}} 
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box green-haze">
            ...
            <div class="portlet-body">
              ...
              <tr>
                <td>
                  {{BaseController::getTerminalID($contractinfo->atm_id)}}
                </td>
                <td>
                  {{$contractinfo->billingPeriodEnd}}
                </td>
                <td>
                   @if ($contractinfo->fixedPriceContractYN == 1) Yes @else No @endif
                </td>
                <td>
				    @if ($contractinfo->monthlyTransSummaryYN == 1) Yes @else No @endif
                </td>
                <td>
                   {{$contractinfo->lowThreshold}}
                </td>
                <td>
                   {{$contractinfo->highThreshold}}
                </td>
                <td>
                   {{$contractinfo->thresholdRate}}
                </td>
                <td>
                   {{$contractinfo->fixedPriceAmount}}
                </td>
				<td class="table-action">
				  <a href="{{ URL::route("admin/atm_edit", $contractinfo->id) }}"><i class="fa fa-pencil"></i></a>
				</td>              
              </tr>
              @endforeach  
              </tbody>
