...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
	...
	@endif
      <!-- BEGIN PAGE CONTENT-->
      {{Form::open(array('url' => 'admin/branch_delete', 'method' => 'post', 'class' => 'form', 'id' => 'branchForm', 'autocomplete' => 'off'))}} 
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box green-haze">
            ...
            <div class="portlet-body">
              ...
              <tr>
                <td>
                   {{BaseController::getBank($branchinfo->bank_id)}}
                </td>
                <td>
                  {{$branchinfo->bankAddress}}
                </td>
                <td>
                   {{$branchinfo->bankPhone}}
                </td>
                <td>
                   {{$branchinfo->bankContactName}}
                </td>                
				<td class="table-action">
				  <a href="{{ URL::route("admin/branch_edit", $branchinfo->id) }}"><i class="fa fa-pencil"></i></a>
          &nbsp;&nbsp;
          <a href="#" onclick="doDelete('{{$branchinfo->id}}')" class="delete-row{{$branchinfo->id}}"><i class="fa fa-trash-o"></i></a>          
				</td>              
              </tr>
              @endforeach  
              </tbody>
    ...
    $.confirm({
      ...
      'buttons' : {
        'Yes' : {
          ...
          'action': function(){   
            jQuery('#id').val(id);
            $( '#branchForm' ).ajaxForm(options).submit();           
          }
        },
        'No'  : {
          'class' : 'gray',
