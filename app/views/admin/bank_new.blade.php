        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            ...
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
			  @if ($bankByID == null)
              {{Form::open(array('url' => 'admin/bank_add', 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'bankAdd', 'autocomplete' => 'off'))}}
			  @else
              {{Form::open(array('url' => 'admin/bank_update', 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'bankAdd', 'autocomplete' => 'off'))}}
			  @endif
				<input type="hidden" name="id" id="id" value="@if($bankByID != null){{$bankByID->id}}@endif">
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    * </span>
                    ...
                    <div class="col-md-4">
                      <input type="text" name="bankName" data-required="2" class="form-control" value="@if($bankByID != null){{$bankByID->bankName}}@endif"/>
                    </div>
                </div>
				<div class="form-actions">
				  <div class="row">
					<div class="col-md-offset-3 col-md-9">
					  ...
					  <a href="{{URL::route('admin/banks')}}" class="btn default">Cancel</a>
					</div>
				  </div>
				</div>
              </form>
