...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
	...
	@endif
      <!-- BEGIN PAGE CONTENT-->
      {{Form::open(array('url' => 'admin/client_delete', 'method' => 'post', 'class' => 'form', 'id' => 'clientForm', 'autocomplete' => 'off'))}} 
            ...
            <div class="portlet-body">
              ...
              <tr>
				...
				<td class="table-action">
				  <a href="{{ URL::route("admin/client_edit", $clientinfo->id) }}"><i class="fa fa-pencil"></i></a>
				  &nbsp;&nbsp;
				  <a href="#" onclick="doDelete('{{$clientinfo->id}}')" class="delete-row{{$clientinfo->id}}"><i class="fa fa-trash-o"></i></a>
				</td>              
              </tr>
              @endforeach  
              </tbody>
...
<script>
  ...
  function doDelete(id) {
    $.confirm({
      ...
      'message' : 'Do you really want to delete selected client?',
      'buttons' : {
        'Yes' : {
          'class' : 'blue',
          'action': function(){   
            jQuery('#id').val(id);
            $( '#clientForm' ).ajaxForm(options).submit();           
          }
        },
        'No'  : {
          'class' : 'gray',
