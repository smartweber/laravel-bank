...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
	...
	@endif
      <!-- BEGIN PAGE CONTENT-->
      {{Form::open(array('url' => 'admin/bank_delete', 'method' => 'post', 'class' => 'form', 'id' => 'bankForm', 'autocomplete' => 'off'))}} 
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box green-haze">
            ...
            <div class="portlet-body">
              ...
              <tr>
                <td>
					<a href="{{ URL::route("admin/bank_edit", $bankinfo->id) }}">{{$bankinfo->bankName}}</a>                   
                </td>
				<td class="table-action">
				  <a href="{{ URL::route("admin/bank_edit", $bankinfo->id) }}"><i class="fa fa-pencil"></i></a>
				  &nbsp;&nbsp;
				  <a href="#" onclick="doDelete('{{$bankinfo->id}}')" class="delete-row{{$bankinfo->id}}"><i class="fa fa-trash-o"></i></a>
				</td>              
              </tr>
              @endforeach  
              </tbody>
    ...
    $.confirm({
      ...
      'buttons' : {
        'Yes' : {
          ...
          'action': function(){   
            jQuery('#id').val(id);
            $( '#bankForm' ).ajaxForm(options).submit();           
          }
        },
        'No'  : {
          'class' : 'gray',
